...
class WithdrawMoneyView(TransactinViewsMixin):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f'You successfully withdraw {amount}Tk. from your account')
...
class LoanRequestView(TransactinViewsMixin):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f'Loan request for {amount}Tk. has been successfully sent to admin')
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            if sender.balance >=0 and transfer_amount<=sender.balance:
                ...
                messages.success(self.request, 'Balance Transfered Successfully')   
